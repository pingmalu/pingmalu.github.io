...
```sh
curl -L -o "%TEMP%\update_keybindings.bat" "https://raw.githubusercontent.com/pingmalu/pingmalu.github.io/master/public_bash/vscode_config/update_keybindings.bat" && "%TEMP%\update_keybindings.bat"
...
```sh
curl -L -o "%TEMP%\update_keybindings.bat" "https://gh-proxy.com/https://raw.githubusercontent.com/pingmalu/pingmalu.github.io/master/public_bash/vscode_config/update_keybindings_cn.bat" && "%TEMP%\update_keybindings_cn.bat"

curl -fsSL "https://gh-proxy.com/https://raw.githubusercontent.com/pingmalu/pingmalu.github.io/master/public_bash/vscode_config/update_keybindings.bat" -o "%TEMP%\update_keybindings_cn.bat" && call "%TEMP%\update_keybindings_cn.bat"

powershell -Command "Invoke-WebRequest -Uri 'https://gh-proxy.com/https://raw.githubusercontent.com/pingmalu/pingmalu.github.io/master/public_bash/vscode_config/update_keybindings_cn.bat' -OutFile '%TEMP%\update_keybindings_cn.bat'; Start-Process -FilePath '%TEMP%\update_keybindings_cn.bat'"
```
