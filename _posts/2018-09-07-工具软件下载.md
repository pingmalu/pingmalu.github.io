...
[https://github.com/firejox/hang-stdin#keep-wsl-distro-alive](https://github.com/firejox/hang-stdin#keep-wsl-distro-alive)
...
Terminal: 配置：可执行文件：C:\Program Files\Git\bin\bash.exe   参数：-i -d  快捷键：在终端开启当前目录 内部  CTRL+J
